...
const yearMonth = document.querySelector<HTMLElement>('#yearMonth')!;
const prev = document.querySelector<HTMLButtonElement>('#prev')!;
const next = document.querySelector<HTMLButtonElement>('#next')!;
const right = document.querySelector<HTMLElement>('#right')!;
const calendarmemo = document.querySelector<HTMLElement>('#calendarmemo')!;
...
if (savedOnedays) {
  ...
  parsedOnedays.forEach((oneday: Onedays) => {
    onedays.push(oneday);
  });
}
